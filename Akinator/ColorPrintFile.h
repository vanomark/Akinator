...
#define RED(exp)    RED_SYMBOLS exp DEFAULT_COLOR
#define CYAN(exp)   CYAN_SYMBOLS exp DEFAULT_COLOR
#define GREEN(exp)  GREEN_SYMBOLS exp DEFAULT_COLOR
#define YELLOW(exp) YELLOW_SYMBOLS exp DEFAULT_COLOR
#define WHITE(exp)  LIGHTWHITE_SYMBOLS exp DEFAULT_COLOR
